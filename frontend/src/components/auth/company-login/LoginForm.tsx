...
import { LoginFormData, LoginErrors } from "@/types/auth/company-login/company-login.types";
        ...
        <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950 flex items-center justify-center p-4">
            ...
            >
                ...
                <p className="mt-8 text-center text-xs text-neutral-500">
                    ...
                    <Link href="/terms" className="underline hover:text-neutral-300 transition-colors">Terms of Service</Link>{" "}
                    and{" "}
