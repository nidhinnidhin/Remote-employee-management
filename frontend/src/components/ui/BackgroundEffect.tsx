    ...
    return (
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
            ...
            >
                ...
                <circle cx="70%" cy="80%" r="1" className="fill-white/30" />
                <circle cx="50%" cy="10%" r="1" className="fill-white/30" />
                <circle cx="30%" cy="90%" r="1" className="fill-white/30" />
                <circle cx="95%" cy="50%" r="1" className="fill-white/30" />

                {/* Faint Connecting Lines crossing screen */}
                <path
