      ...
      <div className="py-5 px-6 rounded-xl bg-white/[0.02] border border-dashed border-white/10 flex items-center gap-4 transition-all hover:bg-white/[0.03]">
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-[10px] text-slate-500 font-medium uppercase tracking-widest">
            No individual sub-tasks assigned.
          </p>
        </div>
      </div>
    );
        ...
        {tasks.map((task) => {
          return (
            <div
              ...
              className="group flex items-center gap-4 p-3 rounded-xl bg-white/[0.01] border border-white/5 hover:border-white/10 hover:bg-white/[0.03] transition-all duration-300 cursor-pointer"
            >
              {/* Index/Icon Area */}
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] leading-relaxed text-slate-500 line-clamp-1 mt-0.5">
              ...
              <div className="flex items-center gap-3">
                    ...
                    <select
                      ...
                      className={cn(
                        ...
                        task.status === TaskStatus.DONE &&
                          "text-green-400 border-green-400/20 hover:border-green-400/40",
                      )}
                    >
                ...
                <TaskStatusBadge
                  status={task.status}
                  className="scale-90 origin-right hidden lg:flex opacity-60"
                />
              </div>
            </div>
          );
