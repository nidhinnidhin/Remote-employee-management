...
export default function EmployeeMeetingRoomPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (meeting.status === 'ENDED') {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-[#0a0b0d]">
        ...
        <p className="text-xs text-slate-400">This meeting has already been ended by the host.</p>
      </div>
    );
  }
