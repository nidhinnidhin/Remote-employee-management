...
export class CreateUserStoryUseCase implements ICreateUserStoryUseCase {
  ...
  async execute(
    ...
    const story = {
      ...
      companyId,
      createdBy: adminId,
      isInBacklog: storyDto.isInBacklog !== undefined ? storyDto.isInBacklog : true,
      status: storyDto.status || (storyDto.isInBacklog === false ? UserStoryStatus.TODO : UserStoryStatus.BACKLOG),
