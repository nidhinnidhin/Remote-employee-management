// src/modules/meeting/application/use-cases/schedule-meeting.usecase.ts
import { Injectable, Inject } from '@nestjs/common';
import { IScheduleMeetingUseCase } from '../interfaces/meeting-use-cases.interface';
...
export class ScheduleMeetingUseCase implements IScheduleMeetingUseCase {
  ...
  async execute(companyId: string, creatorId: string, dto: ScheduleMeetingDto): Promise<MeetingResponseDto> {
