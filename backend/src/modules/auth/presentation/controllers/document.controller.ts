...
export class DocumentController {
  constructor(
    ...
    private readonly _editDocumentUseCase: IEditDocumentUseCase,
  ) {}
  ...
  async uploadDocument(
    ...
    return this._uploadDocumentUseCase.execute({
  ...
  async deleteDocument(
    ...
    return this._deleteDocumentUseCase.execute(
      req.user!.userId,
      documentId,
      publicId,
      resourceType,
  ...
  async editDocument(
    ...
    return this._editDocumentUseCase.execute({
      userId: req.user!.userId,
      documentId,
      name,
      category,
